      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-12">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Reseñas en Google</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-3">Lo que dicen nuestros clientes</h2>
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            {reviews.map((r) => (
              <div key={r.id} className="bg-white p-6 sm:p-8 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col h-full">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center space-x-3">
                    <img src={r.img || `https://i.pravatar.cc/150?u=${r.id}`} alt={r.name} className="w-10 h-10 rounded-full object-cover" />
                    <div>
                      <h4 className="font-bold text-slate-900 text-sm flex items-center">
                        {r.name}
                        <CheckCircle2 size={12} className="ml-1 text-pink-500" />
                      </h4>
        ...
        <div className="mt-10 text-center">
          <a 
            ...
            className="text-pink-500 font-bold text-sm hover:underline inline-flex items-center mx-auto"
          >
